...
const dummyClients: Client[] = [
  { id: 1, name: 'John Doe', email: 'john@example.com', phone: '123-456-7890', address: '123 Main St', createdAt: '2023-01-01' },
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', phone: '098-765-4321', address: '456 Elm St', createdAt: '2023-02-15' },
  { id: 3, name: 'Alice Johnson', email: 'alice@example.com', phone: '555-123-4567', address: '789 Oak Ave', createdAt: '2023-03-20' },
  { id: 4, name: 'Bob Williams', email: 'bob@example.com', phone: '777-888-9999', address: '321 Pine Rd', createdAt: '2023-04-05' },
]
